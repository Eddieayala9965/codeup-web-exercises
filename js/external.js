...
let googleMoney = prompt("Google pays $400.00 per hour and you worked 6 hours. Whats your total?")
let googlePay = parseInt(googleMoney)
console.log(`Pay ${googlePay}`)
let amazonMoney = prompt("Amazon pays $380.00 per hour and you worked 4 hours. Whats your total?")
